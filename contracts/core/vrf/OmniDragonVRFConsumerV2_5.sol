...
import {OApp, MessagingFee, Origin} from "@layerzerolabs/oft-evm/contracts/oapp/OApp.sol";
import {MessagingReceipt} from "@layerzerolabs/oft-evm/contracts/oapp/OAppSender.sol";
import {OAppOptionsType3} from "@layerzerolabs/oft-evm/contracts/oapp/libs/OAppOptionsType3.sol";
import {OptionsBuilder} from "@layerzerolabs/oft-evm/contracts/oapp/libs/OptionsBuilder.sol";
...
library VRFV2PlusClient {
  ...
  function _argsToBytes(ExtraArgsV1 memory extraArgs) internal pure returns (bytes memory bts) {
    return abi.encodeWithSelector(bytes4(keccak256("CC76")), extraArgs);
  }
}
